...
function Team({ officers }) {
  return (
    <section class="relative py-20 overflow-hidde bg-gradient-to-b from-gray-100 to-white">
      {/* <span class="absolute top-0 right-0 flex flex-col items-end mt-0 -mr-16 opacity-60">
        <span class="container hidden w-screen h-32 max-w-xs mt-20 transform rounded-full rounded-r-none md:block md:max-w-xs lg:max-w-lg 2xl:max-w-3xl bg-blue-50">
      ...
      <div class="relative px-16 mx-auto max-w-7xl">
        ...
        {/* <div class="w-full flex justify-center mt-8">
          <Link href="#_">
            <div class="cursor-pointer px-8 py-4 sm:w-auto w-full text-center text-base font-medium inline-block rounded text-white hover:bg-indigo-600 bg-indigo-500">
              View All Members
            </div>
          </Link>
        </div> */}
